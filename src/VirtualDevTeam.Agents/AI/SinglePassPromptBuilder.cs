...
public static class SinglePassPromptBuilder
{
        ...
        CancellationToken ct = default)
    {
        ...
        sb.Append("- **CRITICAL for T1 .gitignore**: The .gitignore must be comprehensive and technology-specific — derived from the ");
        sb.Append(inputs.TechStack ?? "project's");
        sb.Append(" stack and architecture. Cover: build/compiler output, dependency directories, package artifacts, ");
        sb.Append("IDE/editor files, OS junk, secrets/env, test/coverage output, logs/temp/cache, and framework-generated files. ");
        sb.Append("For multi-component projects, cover ALL technologies in one root file. ");
        sb.Append("Do NOT ignore lockfiles, migrations, seed data, or runtime data files the app needs.\n");
