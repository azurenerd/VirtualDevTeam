...
public record VisualJudgeInput
{
    ...
    /// <summary>Candidate id → runtime interaction context (console errors, failed requests, etc.).</summary>
    public IReadOnlyDictionary<string, InteractionContext>? CandidateInteractionContexts { get; init; }
}
