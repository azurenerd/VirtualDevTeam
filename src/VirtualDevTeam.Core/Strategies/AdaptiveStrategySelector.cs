...
///
/// **NoMessyCodePlan Theme 9:** this class is currently NOT invoked by
/// <see cref="StrategyOrchestrator"/> — it's reserved for the Phase-5 val-e2e
/// data-collection milestone. New contributors exploring strategy orchestration
/// should ignore this until that milestone — see <c>StrategyOrchestrator.cs:112-118</c>
/// for the explanatory comment.
/// </summary>
[Obsolete("Not currently invoked — reserved for the Phase-5 val-e2e milestone. " +
    "See StrategyOrchestrator.cs:112-118 and NoMessyCodePlan.md Theme 9. " +
    "Suppress this warning with #pragma when intentionally wiring it up.", error: false)]
