...
public interface IWorkItemService
{
    ...
    /// <summary>
    /// List ALL work items for the project, ignoring any run-scope filter.
    /// Use from display/history contexts (e.g. Timeline) — not from agent claiming logic.
    /// </summary>
    Task<IReadOnlyList<PlatformWorkItem>> ListAllForProjectAsync(CancellationToken ct = default);
