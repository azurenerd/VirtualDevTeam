...
public partial class DocumentReferenceResolver : IDocumentReferenceResolver
{
    ...
    [GeneratedRegex(@"(?:^|\s)((?:AgentDocs|\.virtualdevteam)/[^\s""'<>]+\.md|(?:PMSpec|Research|Architecture|EngineeringPlan|TeamMembers|TeamComposition)\.md)", RegexOptions.IgnoreCase | RegexOptions.Multiline)]
