...
public record AgentDecision
{
    ...
    /// <summary>
    /// PR number this decision is associated with. When set, the PR cannot merge
    /// until this decision is approved (if gated).
    /// </summary>
    public int? AssociatedPrNumber { get; init; }

    /// <summary>
    /// The original wizard clarifying question this decision answers (if from unanswered Q).
    /// Null for implicit/ambient decisions made during normal agent work.
    /// </summary>
    public string? SourceQuestion { get; init; }

    /// <summary>
    /// Who approved/rejected this decision. "human" for dashboard UI, "flow-monitor" for
    /// FlowMonitor auto-approval, null if not yet resolved.
    /// </summary>
