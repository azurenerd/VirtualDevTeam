...
public class PlaywrightHealthService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            // Signal startup validation is done (success or failure) so agents waiting
            // on StartupValidationComplete can proceed with IsReady checks.
            _runner.SignalStartupComplete();
        }
