...
public sealed class HttpGateNotificationService : IDisposable
{
    ...
    {
        _ = _http.PostAsync($"/api/notifications/{notificationId}/dismiss", null);
    }

    public void DismissAllFlowMonitorInfo()
    {
        _ = _http.PostAsync("/api/notifications/dismiss-flow-monitor", null);
    }
