...
> 📖 Want the full tour? The dashboard has an **Interactive Walkthrough** (22 GIFs) at `https://localhost:5050/walkthrough` ([Markdown Link](https://github.com/azure-core/VirtualDevTeam/blob/main/docs/Walkthrough.md)).
...
*(Prefer a binary? `irm https://raw.githubusercontent.com/azure-core/VirtualDevTeam/main/scripts/install.ps1 | iex`, then `vdt start`.)*
...
- 📘 **README:** [github.com/azure-core/VirtualDevTeam/blob/main/README.md](https://github.com/azure-core/VirtualDevTeam/blob/main/README.md)
- 🎬 **Walkthrough:** [github.com/azure-core/VirtualDevTeam/blob/main/docs/Walkthrough.md](https://github.com/azure-core/VirtualDevTeam/blob/main/docs/Walkthrough.md)
