...
namespace VirtualDevTeam.Dashboard.Tests.Helpers;
...
public static class GifReportGenerator
{
    public static string Generate(List<ScenarioResult> results, string outputDir)
    {
        ...
        sb.AppendLine("<title>VirtualDevTeam UI Test Report</title>");
        sb.AppendLine("<style>");
        sb.AppendLine(Css);
        sb.AppendLine("</style>");
        sb.AppendLine("</head>");
        ...
        sb.AppendLine("<h1>🎬 VirtualDevTeam UI Test Report</h1>");
