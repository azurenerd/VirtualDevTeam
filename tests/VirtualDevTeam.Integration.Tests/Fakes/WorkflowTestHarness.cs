...
/// <summary>
/// Lightweight test harness that wires up the core VirtualDevTeam DI container
...
public sealed class WorkflowTestHarness : IDisposable
{
    ...
    public static WorkflowTestHarness Create(Action<VirtualDevTeamConfig>? configureOptions = null)
    {
        ...
        services.AddSingleton<IOptionsMonitor<VirtualDevTeamConfig>>(
            new OptionsMonitorStub<VirtualDevTeamConfig>(config));
        ...
        // DevPlatform config + capability adapters (wraps IGitHubService)
