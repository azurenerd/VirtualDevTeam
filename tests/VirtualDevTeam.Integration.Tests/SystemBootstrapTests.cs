...
public class SystemBootstrapTests : IDisposable
{
    ...
    public SystemBootstrapTests()
    {
        ...
        services.AddSingleton(new Mock<VirtualDevTeam.Core.DevPlatform.Capabilities.IPullRequestService>().Object);
        services.AddSingleton(new Mock<VirtualDevTeam.Core.DevPlatform.Capabilities.IWorkItemService>().Object);
        services.AddSingleton(new Mock<VirtualDevTeam.Core.DevPlatform.Capabilities.IRepositoryContentService>().Object);
        services.AddSingleton(new Mock<VirtualDevTeam.Core.DevPlatform.Capabilities.IReviewService>().Object);
        services.AddSingleton(new Mock<VirtualDevTeam.Core.DevPlatform.Capabilities.IBranchService>().Object);
        ...
        // Persistence
        var testDbPath = Path.Combine(Path.GetTempPath(), $"virtualdevteam-test-{Guid.NewGuid():N}.db");
        ...
        services.AddSingleton(sp => new VirtualDevTeam.Core.Agents.AgentCoreServices(
            ...
            modelRegistry: sp.GetRequiredService<VirtualDevTeam.Core.Configuration.ModelRegistry>(),
        ...
        services.AddSingleton(sp => new VirtualDevTeam.Core.Agents.AgentPlatformServices(
            ...
            docResolver: sp.GetService<VirtualDevTeam.Core.DevPlatform.Capabilities.IDocumentReferenceResolver>(),
        ...
        services.Configure<VirtualDevTeam.Core.DevPlatform.Config.DevPlatformConfig>(cfg =>
        {
            cfg.Platform = VirtualDevTeam.Core.DevPlatform.Config.DevPlatformType.GitHub;
        });
