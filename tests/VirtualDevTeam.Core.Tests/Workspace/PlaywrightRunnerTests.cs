...
public class PlaywrightRunnerTests : IDisposable
{
    ...
    {
        _runner = new PlaywrightRunner(
            NullLogger<PlaywrightRunner>.Instance,
            new AppLauncher(NullLogger<AppLauncher>.Instance, null),
            new MediaRecorder(NullLogger<MediaRecorder>.Instance),
            new ApiSmokeRunner(NullLogger<ApiSmokeRunner>.Instance, new AppLauncher(NullLogger<AppLauncher>.Instance, null)));
