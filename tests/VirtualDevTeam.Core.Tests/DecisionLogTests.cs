...
public class InlineImpactClassificationTests
{
    ...
    public void ParseAssessment_WithImpactClassification_ExtractsAllFields()
    {
        ...
        var result = VirtualDevTeam.Core.Agents.Reasoning.SelfAssessmentService.ParseAssessment(response, parseImpact: true);
    ...
    public void ParseAssessment_WithoutImpactFlag_IgnoresImpactFields()
    {
        ...
        var result = VirtualDevTeam.Core.Agents.Reasoning.SelfAssessmentService.ParseAssessment(response, parseImpact: false);
    ...
    {
        var result = new VirtualDevTeam.Core.Agents.Reasoning.AssessmentResult
        {
            Passed = true,
            Gaps = [],
            Summary = "OK",
